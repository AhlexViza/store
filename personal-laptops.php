<?php $conexion = mysqli_connect("localhost", "root", "rootroot", "mikrotel_cusco"); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <nav class="menu">
        <section class="menu__container">
            ...
            <ul class="menu__links">
                <li class="menu__item">
                    <a href="index.php" class="menu__link">Novedades</a>
                </li>

                <li class="menu__item  menu__item--show">
                    <a href="personal-computer.php" class="menu__link">PC<img src="assets/arrow.svg" class="menu__arrow"></a>
    
                    <ul class="menu__nesting">
                        <li class="menu__inside">
                            <a href="personal-computer.php#Gaming" class="menu__link menu__link--inside">Gaming</a>
                        </li>
                        <li class="menu__inside">
                            <a href="personal-computer.php#Oficina" class="menu__link menu__link--inside">Oficina y Negocios</a>
                        </li>
                        <li class="menu__inside">
                ...
                <li class="menu__item menu__item--show">
                    <a href="personal-laptops.php" class="menu__link">Laptops<img src="assets/arrow.svg" class="menu__arrow"></a>
    
                    <ul class="menu__nesting">
                        <li class="menu__inside">
                            <a href="personal-laptops.php#Gaming" class="menu__link menu__link--inside">Gaming</a>
                        </li>
                        <li class="menu__inside">
                            <a href="personal-laptops.php#Oficina" class="menu__link menu__link--inside">Ultrabooks</a>
                        </li>
                        <li class="menu__inside">
                ...
                <li class="menu__item  menu__item--show">
                    <a href="accesorios.php" class="menu__link">Accesorios<img src="assets/arrow.svg" class="menu__arrow"></a>
                ...
                <li class="menu__item  menu__item--show">
                    <a href="componentes.php" class="menu__link">Componentes<img src="assets/arrow.svg" class="menu__arrow"></a>
            ...
            <div class="menu-right">
                <div >
                    <form class="busqueda" action="search.php" method="GET">
                        <input class="input-text" name="search" type="text" placeholder="buscar">
                        <button type="submit" class="btn-search"><img src="assets/buscar.svg"></button>
                    </form>
                </div>
                <div class="login">
                <a href="account/enter-account.php" class="btn-login"><img src="assets/login.svg" alt="Login"></a>
                </div>
    ...
    <div class="banner" id="Oficina">
        <div class="overlay">
            ...
            <label>Laptops para Oficina</label>  
        </div>
    ...
    <?php
        $mostrar="SELECT `codigo_producto`, `titulo_producto`, `marca_producto`, `precio_producto`, `categoria_producto`, `cantidad_producto`, `descripcion_producto`, `imagen_producto` 
                FROM `mikrotel_producto` WHERE titulo_producto LIKE '%laptop%' and categoria_producto LIKE '%oficina%'";
        $resultado = mysqli_query($conexion,$mostrar);
        if ($resultado) {
            ?><div class="product-list"><?php
            while($row = $resultado->fetch_array()){
                $codigo_producto = $row['codigo_producto'];
                $titulo_producto = $row['titulo_producto'];
                $marca_producto = $row['marca_producto'];
                $precio_productocio = $row['precio_producto'];
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <div class="product-brand"><?php echo $marca_producto; ?></div>
                        <div class="product-title"><?php echo $titulo_producto; ?></div>
                        <div class="product-store"> Codigo: <?php echo $codigo_producto; ?></div>
                        <div class="product-price">
                            S/ <?php echo $precio_productocio; ?>
    ...
    <div class="banner" id="Gaming">
        <div class="overlay">
            <p>Encuentra lo mejor en</p>
            <label>Laptops para Gaming</label>
        </div>
        <div class="img_overlay">
            <img src="assets/laptops-gamer-intel.jpg" alt="">
        </div>
    ...
    <?php
        $mostrar="SELECT `codigo_producto`, `titulo_producto`, `marca_producto`, `precio_producto`, `categoria_producto`, `cantidad_producto`, `descripcion_producto`, `imagen_producto` 
                FROM `mikrotel_producto` WHERE titulo_producto LIKE '%laptop%' and categoria_producto LIKE '%gaming%'";
        $resultado = mysqli_query($conexion,$mostrar);
        if ($resultado) {
            ?><div class="product-list"><?php
            while($row = $resultado->fetch_array()){
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <div class="product-brand"><?php echo $marca_producto; ?></div>
                        <div class="product-title"><?php echo $titulo_producto; ?></div>
                        <div class="product-store"><?php echo $categoria_producto; ?></div>
                        <div class="product-price">
                            S/ <?php echo $precio_productocio; ?>
                            <div class="product-discount">Oferta</div>
                        </div>
