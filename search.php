...
<body>
    ...
    <?php
        ...
        if (!empty($search)) {
            $sql .= " WHERE titulo_producto LIKE '%$search%' OR marca_producto LIKE '%$search%'";
        }
        /*$sql = "SELECT * FROM producto 
                WHERE MATCH(titulo) AGAINST('$search' IN NATURAL LANGUAGE MODE)";*/
        ...
        if ($resultado->num_rows > 0) {
            ...
            ?> 
            <div class="producto_no_found">
                <img src="assets/robot-error.svg" alt="">
                <h2>Ups. Lo sentimos, No encontramos ningún resultado para tu búsqueda</h2>
                Pero no te desanimes, verifica la ortografía o intenta una búsqueda menos específica.
            </div>
            <?php
        }
    ?>
